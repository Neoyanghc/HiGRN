...
from lib.executor.abstract_executor import AbstractExecutor
from lib.utils import get_evaluator, ensure_dir
from lib.model import loss
from functools import partial
import neptune.new as neptune


class StateExecutor(AbstractExecutor):
    def __init__(self, config, model):
        ...
        self.cache_dir = './lib/cache/{}/model_cache'.format(self.exp_id)
        self.evaluate_res_dir = './lib/cache/{}/evaluate_cache'.format(self.exp_id)
        self.summary_writer_dir = './lib/cache/{}/'.format(self.exp_id)
    ...
    def evaluate(self, test_dataloader):
        ...
        with torch.no_grad():
            ...
            for batch in test_dataloader:
                ...
                output, _ = self.model.predict(batch)
